...
<!-- STARS:START -->
[![Total Stars](https://img.shields.io/badge/total%20stars-189-yellow?style=flat-square&logo=github)](https://github.com/dcondrey?tab=repositories&sort=stargazers)
<!-- STARS:END -->
...
- [`cogmem`](https://github.com/dcondrey/cogmem) — self-improving, verifiable memory layer for AI coding agents
- [`misterdev`](https://github.com/dcondrey/misterdev) — autonomous LLM build orchestrator: plans a goal into tasks, edits code with anchored search/replace, verifies every change through build/test/lint/typecheck gates
- [`crosstalk`](https://github.com/dcondrey/crosstalk) — metacognitive multi-agent orchestrator with an adaptive debate swarm, sandboxed verification, and tamper-evident transcripts

### Applied ML — PAN & CLEF 2026

Competitive results in AI-text detection and authorship analysis:

- [`trajectory-detection-clef2026`](https://github.com/dcondrey/trajectory-detection-clef2026) — 1st place source detection (0.85 F1), 3rd place safety classification
- [`simpletext-clef2026`](https://github.com/dcondrey/simpletext-clef2026) — 2nd place, Task 2 (SARI 47.43)
- [`voight-kampff-clef2026`](https://github.com/dcondrey/voight-kampff-clef2026) — AI-generated text detection, 0.891 ROC-AUC
- [`style-change-clef2026`](https://github.com/dcondrey/style-change-clef2026), [`sense-clef2026`](https://github.com/dcondrey/sense-clef2026) — multi-author style analysis, ordinal sensemaking
...
- Opened PR in [brandonhimpfen/awesome-github-actions](https://github.com/brandonhimpfen/awesome-github-actions)
- Opened PR in [sdras/awesome-actions](https://github.com/sdras/awesome-actions)
<!-- ACTIVITY:END -->
...
![David's GitHub stats](https://github-readme-stats.vercel.app/api?username=dcondrey&show_icons=true&theme=default&hide_border=true)
